...
const trabajadoresAPI_auto = {

    /** Gets all entries from 'trabajadores' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/trabajadores`, requestOptions);
        return response.data;
    },
};

export { trabajadoresAPI_auto };