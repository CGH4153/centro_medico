...
const citasAPI_auto = {
    ...
    getById: async function(id) {
        let response = await axios.get(`${BASE_URL}/citas/${id}`, requestOptions);
    ...
    update: async function(formData, id) {
        let response = await axios.put(`${BASE_URL}/citas/${id}`, formData, requestOptions);
        return response.data;
    },

    /** Deletes an existing entry in 'citas' by its primary key */
    delete: async function(id) {
        let response = await axios.delete(`${BASE_URL}/citas/${id}`, requestOptions);
        return response.data;
    },
};
