...
const pacientesconedadAPI_auto = {

    /** Gets all entries from 'pacientesconedad' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/pacientesconedad`, requestOptions);
        return response.data;
    },
};

export { pacientesconedadAPI_auto };