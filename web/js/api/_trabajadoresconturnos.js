...
const trabajadoresconturnosAPI_auto = {

    /** Gets all entries from 'trabajadoresconturnos' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/trabajadoresconturnos`, requestOptions);
        return response.data;
    },
};

export { trabajadoresconturnosAPI_auto };